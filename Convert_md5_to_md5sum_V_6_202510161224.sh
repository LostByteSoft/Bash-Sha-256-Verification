...
#!/usr/bin/ffmpeg
	...
	version=2025-10-16_Thursday_12:24:10
	hashtype=md5
...
## -------------------------===== Separator =====-------------------------
echo "The core/code program. Version 6.014"
	echo
...
## -------------------------===== Separator =====-------------------------
	...
	#sed -i '/\.md5/d' /dev/shm/$random.txt			## Remove all lines containing .md5
	#sed -i '/\.md5sums/d' /dev/shm/$random.txt		## Remove all lines containing .md5sums
