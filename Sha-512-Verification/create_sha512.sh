...
## Software name, what is this, version, informations.
	echo "Software name: Sha 512 creator"
	echo "File name : create_sha512.sh"
	echo
	echo "What it does ? Create an sha 512 checksum for a specified name."
	echo
...
echo "The code program."
	...
	echo "$firstline2  $(basename "${VAR}")" > "${file}.sha512"
