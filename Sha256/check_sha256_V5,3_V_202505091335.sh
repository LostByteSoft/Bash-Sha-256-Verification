...
#!/usr/bin/ffmpeg
	...
	version=2025-05-09_Friday_13:35:17
	hashtype=sha256
...
echo -------------------------========================-------------------------
echo "The core/code program. Check ${hashtype}sum. Version 5.335"
	echo
	debugcore=0
	readdata=0
	calsum1=
...
## -f file , -n variable
	...
	if [ -f "$exist" ]; then
		...
		echo "${green}	███████████████████████████████████████████████████████████████${reset}"
		echo
		echo "	OPTIONAL - Associated ${hashtype}sum file NOT found, must select one"
		echo "	OR"
...
part=$((part+1))
echo "-------------------------===== Section $part =====-------------------------"
echo "Software lead out. Version 5.14"
