...
echo -------------------------========================-------------------------
echo "The core/code program. Version 6.345"
	echo
...
## Read and remove line
	...
	functionremovehashname () {
		...
		#grep -v "${hashtype}sum" "/dev/shm/$random.txt" > "/dev/shm/$random.txt1"
		
		## remove all type
		#grep -v "md5sum" "/dev/shm/$random.txt" > "/dev/shm/$random.txt1"
		#grep -v "sha256sum" "/dev/shm/$random.txt" > "/dev/shm/$random.txt1"
		#grep -v "sha384sum" "/dev/shm/$random.txt" > "/dev/shm/$random.txt1"
		#grep -v "sha512sum" "/dev/shm/$random.txt" > "/dev/shm/$random.txt1"
		## remove folder name
		grep -v "$name1" "/dev/shm/$random.txt" > "/dev/shm/$random.txt1"
		}
...
## Temp file eraser
	...
	rm "/dev/shm/$random.txt1" 2> /dev/null
	rm "/dev/shm/${hashtype}sum.${hashtype}sum" 2> /dev/null
